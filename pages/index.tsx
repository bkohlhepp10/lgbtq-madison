...
,
  {
    ...
    description: "This guide was created to support and celebrate queer-friendly spaces across the city.",
    googleMapsUrl: "https://github.com/bkohlhepp10",
  }
];
